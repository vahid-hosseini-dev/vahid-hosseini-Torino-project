...
function SideMenu({ setIsSideOpen }) {
  return (
    <div
      ...
      className="z-[200] fixed flex flex-col justify-start py-8 px-3 gap-5 top-0 right-0 border-[#0000001F]  item-center border rounded-[12px] w-[209px] h-screen bg-white"
    >
